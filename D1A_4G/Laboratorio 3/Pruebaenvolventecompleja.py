...
# Title: Pruebaenvolventecompleja
# Author: GomezCerro
# Copyright: GomezCerro
...
from CalculoPotenciaComunicacionesD1A import CalculoPotenciaComunicacionesD1A  # grc-generated hier_block
...
class Pruebaenvolventecompleja(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pruebaenvolventecompleja")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pruebaenvolventecompleja")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Pruebaenvolventecompleja")
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, 'Ganancia del transmisor', "counter_slider", float)
        self.top_layout.addWidget(self._GTX_win)
        self._Am_range = Range(0, 100, 0.000001, 50, 200)
        ...
        self._Ac_range = Range(0, 75, 0.000001, 70, 200)
        ...
        self.CalculoPotenciaComunicacionesD1A_0 = CalculoPotenciaComunicacionesD1A(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.CalculoPotenciaComunicacionesD1A_0)
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.CalculoPotenciaComunicacionesD1A_0, 0))
...
def main(top_block_cls=Pruebaenvolventecompleja, options=None):
