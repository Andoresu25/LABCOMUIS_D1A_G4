...
class LAB1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "parte 3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("parte 3")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 208000*12
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 45000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 45000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 14000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.qtgui_time_sink_x_0, 3))
