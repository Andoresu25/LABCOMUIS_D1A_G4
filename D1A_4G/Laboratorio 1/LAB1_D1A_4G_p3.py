...
class LAB1_D1A_4G_p3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB1_D1A_4G_p3")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 40000, 1, 0, 0)
...
def main(top_block_cls=LAB1_D1A_4G_p3, options=None):
