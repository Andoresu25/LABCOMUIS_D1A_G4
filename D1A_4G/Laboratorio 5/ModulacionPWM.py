...
class ModulacionPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Amplitud_range = Range(0, 4, 0.1, 4, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*Amplitud, -Amplitud+Offset, 0)
        ...
        self._AA_range = Range(-2, 2, 0.01, 1, 200)
        self._AA_win = RangeWidget(self._AA_range, self.set_AA, "A constante", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._AA_win)
    ...
    def set_Offset(self, Offset):
        self.Offset = Offset
        self.analog_sig_source_x_1.set_offset(-self.Amplitud+self.Offset)
    ...
    def set_Amplitud(self, Amplitud):
        ...
        self.analog_sig_source_x_1.set_amplitude(2*self.Amplitud)
        self.analog_sig_source_x_1.set_offset(-self.Amplitud+self.Offset)
